...
- The "Rel. Volume" intraday metric is an acknowledged placeholder/estimate, not a true RVOL (it divides mean volume by a hardcoded `50_000_000` baseline; no historical average volume is fetched).
